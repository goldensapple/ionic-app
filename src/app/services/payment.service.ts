...
export class PaymentService {
    ...
    getTotal() {
        this.totalPrice = this.apiService.chosenRoom.room_price;
    ...
    getTotalWithTax(){
        // this.totalPriceWithTax = 0;
        this.totalPriceWithTax = this.apiService.chosenRoom.room_price;
        console.log('this.totalPriceWithTax3:' + this.totalPriceWithTax);
    }
    ...
    async doRequest(code?) {
        ...
        if (environment.trainMode === true){
            this.totalPriceWithTax = 1;
        }
